...
CoD.OptionsSettings.CreateGraphicsTab = function (GraphicsTab, LocalClientIndex)
	...
	local FOVScaleSlider = GraphicsTabButtonList:addDvarLeftRightSlider(LocalClientIndex, Engine.Localize("FOV_SCALE"), "cg_fovscale", 0.5, 2, Engine.Localize("FOV_SCALE_DESC"))
	FOVScaleSlider:setNumericDisplayFormatString("%.2f")
	FOVScaleSlider:setRoundToFraction(0.05)
	FOVScaleSlider:setBarSpeed(0.01)
	
	local FOVSensitivity = GraphicsTabButtonList:addDvarLeftRightSelector(LocalClientIndex, Engine.Localize("FOV_SENSITIVITY"), "cg_usefovsensitivity", Engine.Localize("FOV_SENSITIVITY_DESC"))
...
CoD.OptionsSettings.CreateAdvancedTab = function (AdvancedTab, LocalClientIndex)
	...
	CoD.OptionsSettings.Button_AddChoices_StreamerMode(AdvancedTabButtonList:addHardwareProfileLeftRightSelector(Engine.Localize("STREAMER_MODE"), "cl_enableStreamerMode", Engine.Localize("STREAMER_MODE_DESC")))
	AdvancedTabButtonList:addSpacer(CoD.CoD9Button.Height / 2)
