...
CoD.PrivateGameLobby.Dvars[1].hintText = Engine.Localize("ZMUI_ALLOW_AIM_ASSIST_DESC")
CoD.PrivateGameLobby.Dvars[1].labels = {}
...
CoD.PrivateGameLobby.Dvars[2].name = Engine.Localize("ZMUI_CHEATS_CAPS")
CoD.PrivateGameLobby.Dvars[2].hintText = Engine.Localize("ZMUI_CHEATS_DESC")
